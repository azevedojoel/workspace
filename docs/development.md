...
Tool names use underscore notation (e.g., `docs_create`, `gmail_send`) because
LLM APIs (OpenAI, Anthropic) reject dots in tool names. All tool names are
passed through unchanged at runtime.
